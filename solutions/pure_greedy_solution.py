"""
Pure greedy solution for power grid design problem.
Iteratively selects edges that most improve worst-case unmet demand.
"""
...
def pure_greedy_solution(
    ...
    """
    Solve power grid design using pure greedy heuristic.
